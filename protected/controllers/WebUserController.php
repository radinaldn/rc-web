...
class WebUserController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['WebUser']))
		{
			...
			if($model->save())
				Yii::app()->user->setFlash('success', "Administrator baru berhasil ditambahkan!");
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['WebUser']))
		{
			...
			$model->password=$model->hashPassword($_POST['WebUser']['password'],$acak);
			if($model->save())
				Yii::app()->user->setFlash('update', "Profil berhasi diperbarui!");
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax']))
			Yii::app()->user->setFlash('delete', "Administrator berhasil dihapus!");
	...
	public function actionAdmin()
	{
		...
		$model = WebUser::model()->findAll(array(
	...
	public function loadModel($id)
	{
		...
		if($model===null)
			throw new CHttpException(404,'Halaman yang diminta tidak tersedia.');
		return $model;
	}
