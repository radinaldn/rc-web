...
<div class="x_panel">
                ...
                <div class="x_content">
                <h3><i class="fa fa-tasks"></i> <?php print_r($modelKabkota->nama) ?> <small> <?= CHtml::encode(Yii::app()->name); ?> </small></h3>
    <div class="x_title"></div>
          ...
          <select id="myDropDown" class="form-control">
            <option selected="selected" disabled value ="1401010"><?php echo $modelKabkota->nama ?></option>
            <?php
...
<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div style="font-size: 30px; font-weight: bold;" class=" gray"><?php foreach ($modelgetCountHasil as $data) : {
                $presentaseHasil = ($data['total']/$modelJlhKabkota[0]['total']*100);
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: 'SUARA DI <?php print_r($modelKabkota->nama) ?>',
                            //data: [12, 19, 3, 4],
                            data: [<?php 
