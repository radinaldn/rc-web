...
<?php
$kategori =Yii::app()->session->get('level');
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/real-count.jpg" alt="..." class="img-circle profile_img">
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo Yii::app()->request->baseUrl; ?>/custom/production/images/real-count.jpg" alt=""><?php echo $username ?>
        ...
        <!-- /top navigation -->
        <!-- end of user==admin -->
        <?php } else if($kategori=-1 && $kategori>0) {
          ...
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <?php } else { ?>
                <h3>Anda login sebagai Koordinator Kabupaten/Kota
                <?php } ?>
                  <br>
                  <br>
                  <?php
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/suara/dashboard"><i class="fa fa-home"></i>Halaman Utama</a></li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/suara/grafik"><i class="fa fa-bar-chart"></i>Grafik Keseluruhan</a></li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/suara/grafikkabkota/1401"><i class="fa fa-bar-chart"></i>Grafik Per Kabupaten/Kota</a></li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/suara/grafikkec/1401010"><i class="fa fa-bar-chart"></i>Grafik Per Kecamatan & Kelurahan/Desa</a></li>
                  <!-- <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/suara/grafikkeldesa/1401010005"><i class="fa fa-bar-chart"></i>Grafik Per Kelurahan/Desa</a></li> -->
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/suara/admin"><i class="fa fa-tasks"></i>Suara</a></li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/saksi/admin"><i class="fa fa-users"></i>Saksi</a></li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/keldesa/sisakeldesa"><i class="fa fa-tasks"></i>Laporan Belum Masuk</a></li>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kabkota/admin"><i class="fa fa-map-marker"></i> Kabupaten/Kota</a>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/kec/admin"><i class="fa fa-map-marker"></i> Kecamatan</a>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/keldesa/admin"><i class="fa fa-map-marker"></i> Kelurahan/Desa</a></li>
                  <?php if (Yii::app()->session->get('level') == '-1' ) { ?>
                  <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/webUser/admin"><i class="fa fa-user"></i> Administrator</a>
                  <?php } ?>
